...
const AgendaThemes = () => {
  return (
    <Box as="section" pb="24">
      <Box bg="#1A202C" color="white" pt="24" pb="12rem">
        <Box
          maxW={{
            base: 'xl',
            md: '7xl',
        ...
        >
          ...
          >
            <Feature icon={<BiDirections />} title="Delivering quality education with impact">
              The purpose of lorem ipsum is to create a natural looking block of text (sentence,
              paragraph, page, etc.)
            </Feature>
            <Feature icon={<BiHappyBeaming />} title="Classroom innovations: teaching in the 4IR">
              Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat
              nulla pariatur.
            </Feature>
            <Feature icon={<FaGraduationCap />} title="Employability and the future of skills">
              Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt
              mollit anim id est laborum.
            </Feature>
            <Feature icon={<FaRegLifeRing />} title="Measuring success: the transformative impact of teaching">
